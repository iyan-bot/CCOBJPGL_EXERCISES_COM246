...
public class HomeController implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Atable.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            ...
            if (newSelection != null) {
                userntextfield.setText(newSelection.getUsername());
                passwpasswordfield.setText(newSelection.getPassword());
                choyschoicebox.setValue(newSelection.getAccountstatus());
            }
        });
    ...
    private boolean createuser(ActionEvent event) {
        ...
        String username = userntextfield.getText();
